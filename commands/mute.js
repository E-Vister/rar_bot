...
module.exports.run = async (bot, msg, args, database) => {
    ...
    //Not enough values, muted user not exists, wrong time format
    ...
    if (!msg.member.roles.cache.has(role.id)) {
        ...
        //Creating block-info channel for muted user
        await msg.guild.channels.create(`block-info ${toMute.id}`, {
            ...
            //Saving setTimeout id to the database
